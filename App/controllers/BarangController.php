...
class BarangController
{
    ...
    {
        // Hapus data terkait di tabel transaksi yang memiliki kode_barang yang sama
        $deleteTransaksiQuery = "DELETE FROM transaksi WHERE kode_barang = :kode_barang";
        $stmtTransaksi = $this->db->prepare($deleteTransaksiQuery);
        $stmtTransaksi->bindParam(':kode_barang', $id);
        $stmtTransaksi->execute();

        // Setelah data transaksi dihapus, baru hapus data di tabel produk
